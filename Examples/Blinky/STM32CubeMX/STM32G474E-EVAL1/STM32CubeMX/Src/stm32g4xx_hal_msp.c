...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, ADC12_IN6_Pin|ADC12_IN7_Pin|ADC12_IN8_Pin|ADC12_IN9_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PD13     ------> ADC3_IN10
    */
    HAL_GPIO_DeInit(ADC3_IN4_GPIO_Port, ADC3_IN4_Pin);

    HAL_GPIO_DeInit(GPIOD, ADC345_IN7_Pin|ADC345_IN9_Pin|ADC345_IN10_Pin);
  ...
  /* USER CODE END ADC4_MspDeInit 0 */
    ...
    PD13     ------> ADC4_IN10
    */
    HAL_GPIO_DeInit(ADC4_IN1_GPIO_Port, ADC4_IN1_Pin);

    HAL_GPIO_DeInit(GPIOD, ADC45_IN12_Pin|ADC45_IN13_Pin|ADC345_IN7_Pin|ADC345_IN9_Pin
                          |ADC345_IN10_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  /* USER CODE END OPAMP4_MspDeInit 0 */
    ...
    PB13     ------> OPAMP4_VINP
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_10|GPIO_PIN_11|OPAMP4_VOUT_Pin|GPIO_PIN_13);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, SPI2_MISO_Pin|SPI2_MOSI_Pin);
...
void HAL_TIM_OC_MspDeInit(TIM_HandleTypeDef* htim_oc)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE15     ------> TIM1_BKIN
    */
    HAL_GPIO_DeInit(GPIOE, TIM1_CH1N_Pin|TIM1_CH1_Pin|TIM1_CH2N_Pin|TIM1_CH1E11_Pin
                          |TIM1_CH3N_Pin|TIM1_CH3_Pin|TIM1_BKIN_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PD2     ------> TIM3_ETR
    */
    HAL_GPIO_DeInit(GPIOE, TIM3_CH1_Pin|TIM3_CH2_Pin);

    HAL_GPIO_DeInit(TIM3_ETR_GPIO_Port, TIM3_ETR_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PF6     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(GPIOF, TIM5_CH2_Pin|TIM5_CH2F8_Pin|TIM5_CH1_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB7     ------> TIM8_BKIN
    */
    HAL_GPIO_DeInit(GPIOC, TIM8_CH1_Pin|TIM8_CH2_Pin|TIM8_CH3_Pin|TIM8_CH1N_Pin
                          |TIM8_CH2N_Pin|TIM8_CH3N_Pin);

    HAL_GPIO_DeInit(TIM8_BKIN_GPIO_Port, TIM8_BKIN_Pin);
