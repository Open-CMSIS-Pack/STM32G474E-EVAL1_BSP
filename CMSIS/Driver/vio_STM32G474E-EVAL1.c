/******************************************************************************
 * @file     vio_STM32G474E-EVAL1.c
 * @brief    Virtual I/O implementation for board STM32G474E-EVAL1
 * @version  V1.0.0
...
/*! \page vio_STM32G474E-EVAL1 Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | TAMPER button (B2)   | PC13
| vioLED0       | vioSignalOut.0 | LED red       (LD3)  | PF11
| vioLED1       | vioSignalOut.1 | LED green     (LD1)  | PG9
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTF(11), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTG(9),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
...
//  signal,     pin,                   pull resistor,      active state
  { vioBUTTON0, GPIO_PIN_ID_PORTC(13), ARM_GPIO_PULL_UP,   VIO_ACTIVE_LOW }
};
#endif
